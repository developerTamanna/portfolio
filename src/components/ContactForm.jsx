...
const ContactForm = () => {
  ...
  <form onSubmit={handleSubmit(onSubmit)} className="space-y-6 max-w-2xl flex flex-wrap items-center justify-between">
        {/* Name */}
        <div className="w-[49%]">
          ...
          <input
            id="name"
            {...register("name", {...userNameValidation ,...StringValidationCheck })}
        ...
        <div className="w-full">
          ...
          <input
            id="subject"
            {...register("subject", { required: "Subject is required" , ...StringValidationCheck })}
            className="w-full px-4 py-2 bg-white/20 text-white border border-white/30 rounded-md focus:outline-none focus:ring-2 focus:ring-red-500"
        ...
        <div className="w-full">
          ...
          <textarea
            id="message"
            rows="5"
            {...register("message", { required: "Message is required" ,StringValidationCheck })}
            className="w-full px-4 py-2 bg-white/20 text-white border border-white/30 rounded-md focus:outline-none focus:ring-2 focus:ring-red-500"
